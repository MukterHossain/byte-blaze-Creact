...
const Blog = () => {
    ...
    const { comments_count, title, tags, reading_time_minutes, public_reactions_count, published_at } = blog;
            ...
            <article className="space-y-8  dark:text-gray-900">
                <div className="space-y-6">
                    ...
                    <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap  dark:text-gray-800">
                        <Link 
                       to=''
                         onClick={() =>setTapIndex(0)} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tabIndex === 0 ? 'border border-b-0' : ' border-b'} rounded-t-lg dark:border-gray-600 dark:text-gray-900`}>
                        ...
                        <Link 
                        to={`author`}
                         onClick={() =>setTapIndex(1)} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tabIndex === 1 ? 'border border-b-0' : ' border-b'} rounded-t-lg dark:border-gray-600 dark:text-gray-900`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
